...
Este capítulo tem como objetivo apresentar as técnicas de aprendizado de máquina que serão utilizadas neste trabalho,
ressaltando suas aplicações no processamento de linguagem natural.
...
Contudo, as técnicas de \textit{Deep Learning} não se limitam apenas a arquitetura \textit{multilayer perceptron}.
