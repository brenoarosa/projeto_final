...
As redes sociais modificaram a forma como as pessoas interagem e se tornam cada vez mais presentes em suas vidas.
A produção de conteúdo digital, por sua vez, acompanha este crescimento.
Este grande volume de dados produzido dificulta o processo de extração de informaçãos, uma vez que tais dados são
majoritariamente não estruturados.

Ferramentas como o processamento de linguagem natural são capazes de auxiliar a automatização deste procedimento.
...
custoso visto que a anotação destes dados é feita manualmente.

Este trabalho apresenta a elaboração de um método de gerar classificador de \textit{deep learning} para análise de
