% falar do contexto geral de NLP

\section{Pré-Processamentos}

A primeira etapa na preparação de um documento e/ou mensagem para utilização em algoritmos de aprendizado de máquina é a
